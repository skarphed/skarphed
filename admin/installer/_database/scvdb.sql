...
(
  ...
  CSS_SELECTOR Varchar(50) NOT NULL,
  CSS_MOD_ID Integer,
  CSS_WGT_ID Integer,
...
ALTER TABLE CONFIGOWNERS ADD CONSTRAINT CNO_FK_WGT
  FOREIGN KEY (CNO_WGT_ID) REFERENCES WIDGETS (WGT_ID) ON UPDATE CASCADE ON DELETE CASCADE;
...
INSERT INTO REPOSITORIES (REP_ID, REP_NAME, REP_IP, REP_PORT, REP_LASTUPDATE, REP_PUBLICKEY) 
  VALUES (1,'%(REPO)s','%(REPO)s',80,NULL,'');
