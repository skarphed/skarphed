...
(
  ...
  CNF_MOD_ID INT DEFAULT NULL,
  CNF_WGT_ID INT DEFAULT NULL,
  PRIMARY KEY (PARAM)
);
CREATE TABLE CSS
(
...
ALTER TABLE CONFIG ADD CONSTRAINT CNF_FK_MOD
  FOREIGN KEY (CNF_MOD_ID) REFERENCES MODULES (MOD_ID) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE CONFIG ADD CONSTRAINT CNF_FK_WGT
  FOREIGN KEY (CNF_WGT_ID) REFERENCES WIDGETS (WGT_ID) ON UPDATE CASCADE ON DELETE CASCADE;
