...
JS_NO                   = gtk.gdk.pixbuf_new_from_file_at_size(PATH+"/../data/icon/js_no.png",16,16)
JS_SUPPORTED            = gtk.gdk.pixbuf_new_from_file_at_size(PATH+"/../data/icon/js_supported.png",16,16)
JS_MANDATORY            = gtk.gdk.pixbuf_new_from_file_at_size(PATH+"/../data/icon/js_mandatory.png",16,16)
