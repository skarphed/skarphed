...
class SkarphedPage(ObjectPageAbstract):
    ...
    def __init__(self,par,skarphed):
        ...
        self.repo = PageFrame(self,_("Repository"), IconStock.REPO)
        ...
        self.pki = PageFrame(self, _("Public Key"), IconStock.CREDENTIAL)
        ...
        self.settings = PageFrame(self, _("Server Settings"), IconStock.SKARPHED)
