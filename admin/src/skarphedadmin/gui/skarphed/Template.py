...
class TemplatePage(ObjectPageAbstract):
    def __init__(self,parent,template):
        ...
        self.info = PageFrame(self,_("Currently Installed"), IconStock.TEMPLATE)
        ...
        self.upload = PageFrame(self,_("Upload new Template"), IconStock.TEMPLATE)
        ...
        self.repo = PageFrame(self,_("Install Template from Repository"), IconStock.TEMPLATE)
    ...
    def render(self):
        ...
        for available_template in template.getAvailableTemplates():
            self.repostore.append((IconStock.TEMPLATE,
