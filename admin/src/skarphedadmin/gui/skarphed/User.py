...
class UserPage(ObjectPageAbstract):
    def __init__(self,par,user):
        ...
        self.info = PageFrame(self,_("Information"), IconStock.USER)
        self.infobox = gtk.VBox()
        self.info.add(self.infobox)
        self.pack_start(self.info,False)
        
        self.perm = PageFrame(self,_("Permissions / Roles"), IconStock.ROLE)
        ...
        self.perm_rolelabel = FrameLabel(self,_("Please choose the Rights you want to assign to the user here:"), IconStock.ROLE)
        ...
        self.alterpw = PageFrame(self, _("Alter Password"), IconStock.CREDENTIAL)
