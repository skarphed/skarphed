...
(
  ...
  TMP_DESCRIPTION Varchar(2048),
  TMP_AUTHOR Varchar(1024),
  TMP_SIGNATURE Varchar(172) NOT NULL,
  TMP_DATA Blob sub_type 1,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON CONFIG TO SCVREPO WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON DEPENDENCIES TO SCVREPO WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON DEVELOPER TO SCVREPO WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON MODULES TO SCVREPO WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON SESSIONS TO SCVREPO WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON TEMPLATES TO SCVREPO WITH GRANT OPTION;
