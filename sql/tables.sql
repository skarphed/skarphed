...
CREATE TABLE LOCKS
(
  LCK_ID Integer NOT NULL,
  LCK_DATA Varchar(128) NOT NULL,
  LCK_LKT_ID Integer,
  CONSTRAINT PK_LOCKS PRIMARY KEY (LCK_ID)
);
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON LOCKS TO  ZIGAPEDA WITH GRANT OPTION;
 
 CREATE TABLE LOCKTYPES
(
  LKT_ID Integer NOT NULL,
  LKT_TYPE Varchar(32),
  CONSTRAINT PK_LOCKTYPES PRIMARY KEY (LKT_ID)
);
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON LOCKTYPES TO  ZIGAPEDA WITH GRANT OPTION;
